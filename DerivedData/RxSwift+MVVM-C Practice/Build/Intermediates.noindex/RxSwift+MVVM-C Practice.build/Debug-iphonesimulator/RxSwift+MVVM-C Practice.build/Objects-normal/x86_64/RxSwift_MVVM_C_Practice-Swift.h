...
#ifndef RXSWIFT_MVVM_C_PRACTICE_SWIFT_H
#define RXSWIFT_MVVM_C_PRACTICE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="RxSwift_MVVM_C_Practice",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC23RxSwift_MVVM_C_Practice11AppDelegate")
...
SWIFT_CLASS("_TtC23RxSwift_MVVM_C_Practice13SceneDelegate")
...
SWIFT_CLASS("_TtC23RxSwift_MVVM_C_Practice27SearchAirportViewController")
@interface SearchAirportViewController : UIViewController
@property (nonatomic, weak) IBOutlet UIView * _Null_unspecified roundHeadView;
